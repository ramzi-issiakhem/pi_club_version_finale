...
List<dynamic> scolarityData = [
  [
    "Math&Info",
    "La spécialité sert à approfondir les connaissances des étudiants en mathématiques et informatiques " ," Algo1 | Analyse1 | Algèbre 1 ","- MP(Mécanique de point) | -CRI(codification et représentation de l'information)","TCE, langue étrangère (Français) ","Algo2, Analyse2, Algèbre2 ","électricité ","Transversale: Bureautique , histoire des sciences ","Secondaire: Stat,OPM(outils programmation mathématiques ),strm (structure machine)/ ",
  ...
  [
    "ST",
    "Une spécialité qui tourne au tour de la science exacte et la technologie elle-meme","Math 1,PHYS 1 ,CHIM 1","Dec1","TCE1 , langue étrangère","MATH 2,PHYS 2,CHIM 2","Dec2","TCE2"," TP PHYS2,TP CHIM2,TP bureautique","TP PHYS1 ,TP CHIM1 ,BUREAUTIQUE1",
  ...
  [
    "Biologie",
    "séance de nature et vie est la science qui étudie et taxonomise tous les genres d' organismes vivants basés sur la chimie , la génétique , la cytologie , et les sciences de la microbiologie et bien plus encoreLe but de toutes ces études est d'entourer la discipline des organismes vivants dans des environnements écologiques, elle appartient à la faculté de la biologie","BIOLOGIE CELLULAIRE | CHIMIE 1 | M.S.I(math statistiques informatique)","DECOUVERTE(GEOLOGIE / PHYSIQUE) , TCE1 ","METHODE TRAVAIL TERMINOLOGIE 1 | HISTOIRE UNIV | SCIENCES EXPER.","BIOLOGIE ANIMALE GENERALE ,BIOLOGIE VEGETALE GENERALE,CHIMIE 2","DECOUVERTE:GEOLOGIE / PHYSIQUE TCE2","  /TRANSVERSAL:METHODE TRAVAIL TERMINOLOGIE ",
  ...
  [
    "SM",
    "science de la matière ou encore physique-chimie c'est une spécialitée qui se base comme l'indique son appelation sur ''la matière'' ,la chimie étudie la composition de la matière et  la physique étudie les états de la matière.  La licence en SM apporte une solide formation en physique et en chimie qui permet à son titulaire d’intégrer de nombreux secteurs: (environnement, industrie, matériaux, énergie.)  la  spécialité appartient à les faculté de physique et chimie "," Math 1,PHYS 1 ,CHIM 1"," Dec1 ","TCE1 , langue étrangère  "," TP PHYS1 ,TP CHIM1 ,BUREAUTIQUE1 ","MATH 2,PHYS 2,CHIM 2","Dec2","TCE2,","TP PHYS2,TP CHIM2,TP bureautique ",
